package android.common.utils.file
...
import android.common.utils.image.ImageUtil
import java.io.*
...
object FileUtil {
    ...
    fun string2MediaFileType(str: String): MediaFileType? {
        var ret: MediaFileType? = null
        when (str) {
            "Movie" -> {
                ret = MediaFileType.MOVIE
            }
            "Music" -> {
                ret = MediaFileType.MP3
            }
            "Photo" -> {
                ret = MediaFileType.IMG
            }
            "Doc" -> {
                ret = MediaFileType.DOC
            }
            "Apk" -> {
                ret = MediaFileType.APP
            }
            "Rar" -> {
                ret = MediaFileType.RAR
            }
        }
        return ret
    }

    fun mediaFileType2String(type: MediaFileType): String? {
        var ret: String? = null
        when (type) {
            MediaFileType.MOVIE -> {
                ret = "Movie"
